 ...
 * 用法: node deploy.cjs
 *
 * 给别的 Hermes 一句话: 把文件复制到 ~/.hermes/scripts/ 目录，然后 node ~/.hermes/scripts/deploy.cjs
 */
...
const MONITOR_PY_URL = 'https://raw.githubusercontent.com/qq449176836-lang/hermes-watchdog/main/skills/monitor/monitor.py';
...
async function main() {
  ...
  print('  格式: https://open.feishu.cn/open-apis/bot/v2/hook/YOUR_WEBHOOK_TOKEN');
  print('');
